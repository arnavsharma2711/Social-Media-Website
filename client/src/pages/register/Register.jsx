    ...
    <div className="register">
      <div className="registerWrapper">
        <div className="registerLeft">
          <h3 className="registerLogo">RELIER</h3>
          <span className="registerDesc">Connect with friends and the world around you on Relier.</span>
        </div>
        <div className="registerRight">
          <form className="registerBox" onSubmit={handleClick}>
            ...
            <button className="registerRegisterButton" onClick={toLogin}>Log into Account</button>
          </form>
        </div>
      </div>
    </div>
